...
if [ ! -e /home/vagrant/phptestfest-php-src ]; then
    git clone https://github.com/phpcommunity/phptestfest-php-src.git /home/vagrant/phptestfest-php-src
fi


cd /home/vagrant/phptestfest-php-src
sudo -u vagrant ./buildconf
